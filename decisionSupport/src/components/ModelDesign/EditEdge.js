...
@connect(({modelDesign}) => {
  const {colorVisible,editEdgeVisible,selectList,list,Table,message,Button}=modelDesign;
  return{
    editEdgeVisible,
    colorVisible,
    selectList,
...
export default class EditEdge extends Component{
  state={
    ...
    check:this.props.propsNodeData.reverseType==0?false:true,
    selectValue:this.props.propsNodeData.reverseType?this.props.propsNodeData.reverseType:"ONE2ONE",
    columns:[
      {
        title:'属性名称',
  ...
  handleSubmit=(e)=>{
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        if(this.props.editEdge){
          this.props.editEdge(values)
        }
      }
    });
  };
  ...
  handleEdgeCancel=()=>{
    this.props.dispatch({
      type:'modelDesign/setEditEdgeVisible',
      payload:false
    })
  };
  ...
  render(){
    ...
    return(
      <Modal
        title="编辑边"
        visible={this.props.editEdgeVisible}
      ...
      >
            ...
            <Col span={12}>
              ...
              >
                {getFieldDecorator('edgeDesc', {
                  initialValue:propsNodeData.edgeDesc,
            ...
            <Col span={12} style={{fontSize:12}}>
              ...
              >
                {getFieldDecorator('sourceVertex', {
                  initialValue:propsNodeData.sourceVertex,
            ...
            <Col span={12} style={{fontSize:12}}>
              ...
              >
                {getFieldDecorator('targetVertex', {
                  initialValue:propsNodeData.targetVertex,
        ...
        <Row type="flex" align="middle" style={{marginBottom:20}}>
          <Col span={7}>
            <Checkbox onChange={this.onCheckBoxChange} defaultChecked={this.state.check}><span style={{fontSize:12}}>反向关系</span></Checkbox>
          </Col>
          <Col span={17}>
            <Row type="flex" align="middle">
              ...
              <Col span={21}>
                <Select style={{width:"100%"}} placeholder="请选择边类型" defaultValue={this.state.selectValue} onChange={this.selectChange}>
