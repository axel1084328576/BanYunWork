export default {
  ...
  'menu.reduce-modal':'归约聚类模型',
  'menu.model-design':'模型设计',
  'menu.model-mapping':'模型映射',
  'menu.data-import':'数据导入',
  'menu.graph-service':'图引擎服务',
  // 'menu.execution-function':'执行函数',
  // 'menu.intelligent-reasoning':'智能推理',
  'menu.login': '登录',
  'menu.register': '注册',
