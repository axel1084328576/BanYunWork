export default {
  ...
  'menu.businessinfo': 'BusinessInfo',
  'menu.carmanage': 'CarManage',
  'menu.carmanage.carinfomanage': 'CarInfoManage',
  'menu.carmanage.carusecount': 'CarUseCount',
  'menu.carmanage.carmonitortrace': 'CarMonitorTrace',
  'menu.securitymachine': 'SecurityMachine',
  'menu.securitymachine.expresscheck': 'ExpressCheck',
  'menu.securitymachine.replaycheck': 'ReplayCheck',
  'menu.empolyedmanage': 'EmpolyedManage',
  'menu.empolyedmanage.infosafeguard': 'InfoSafeguard',
  'menu.empolyedmanage.infosearch': 'InfoSearch',
  'menu.videomonitor': 'VideoMonitor',
  'menu.videomonitor.videoresource': 'VideoResource',
  'menu.videomonitor.videoreplay': 'VideoReplay',
  'menu.convenientservice': 'ConvenientService',
  'menu.convenientservice.expressnetwork': 'ExpressNetwork',
  'menu.convenientservice.postalnetwork': 'PostalNetwork',
  'menu.convenientservice.postboxmanage': 'PostboxManage',
  'menu.uniformidentity': 'UniformIdentity',
  'menu.uniformidentity.usermanage': 'UserManage',
  'menu.uniformidentity.organizationmanage': 'OrganizationManage',
  'menu.uniformidentity.rolemanage': 'RoleManage',
  'menu.uniformidentity.authoritymanage': 'AuthorityManage',
  'menu.uniformidentity.menusmanage': 'MenusManage',
  'menu.outsideinterface': 'OutsideInterface',
