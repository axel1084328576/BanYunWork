...
export default {
  ...
  'menu.businessinfo': '业务信息',
  'menu.carmanage': '车辆管理',
  'menu.carmanage.carinfomanage': '车辆信息管理',
  'menu.carmanage.carusecount': '车辆使用统计',
  'menu.carmanage.carmonitortrace': '车辆监控轨迹',
  'menu.securitymachine': '安检机联网',
  'menu.securitymachine.expresscheck': '快递企业过检',
  'menu.securitymachine.replaycheck': '回放企业过检',
  'menu.empolyedmanage': '从业人员管理',
  'menu.empolyedmanage.infosafeguard': '人员信息维护',
  'menu.empolyedmanage.infosearch': '人员信息查询',
  'menu.videomonitor': '视频监控管理',
  'menu.videomonitor.videoresource': '视频资源管理',
  'menu.videomonitor.videoreplay': '视频回放',
  'menu.convenientservice': '便民服务',
  'menu.convenientservice.expressnetwork': '快递网点管理',
  'menu.convenientservice.postalnetwork': '邮政网点管理',
  'menu.convenientservice.postboxmanage': '信筒信箱管理',
  'menu.uniformidentity': '系统管理',
  'menu.uniformidentity.usermanage': '用户管理',
  'menu.uniformidentity.organizationmanage': '组织管理',
  'menu.uniformidentity.rolemanage': '角色管理',
  'menu.uniformidentity.authoritymanage': '权限管理',
  'menu.uniformidentity.menusmanage': '菜单管理',
