...
const localeInfo = {
  'en-US': {
    messages: require('C:/WorkCode/BanYunWork/tianjinProject/tjbdp/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'zh-CN': {
    messages: require('C:/WorkCode/BanYunWork/tianjinProject/tjbdp/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
