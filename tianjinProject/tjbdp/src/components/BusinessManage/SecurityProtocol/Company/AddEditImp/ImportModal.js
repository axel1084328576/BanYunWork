...
@connect(({company,loading}) => {
  ...
  return{
    pageSize,page,
    loading:loading.effects['company/Upload'],
  }
})
  ...
  ImportSubmit=(e)=>{
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        if(document.getElementById("importExcel31").files[0]!=undefined){
          formdata.append('file',document.getElementById("importExcel31").files[0]);
        }
        for(let key in data){
